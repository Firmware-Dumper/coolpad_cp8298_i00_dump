...
#modify by fanli to show UI6.0 charging logo in 20150804
BOOT_LOGO = hd720
#modify by fanli to show UI6.0 charging logo in 20150804
BUILD_CTS = yes
BUILD_KERNEL = yes
...
CUSTOM_HAL_CAM_CAL = ar1335_otp
CUSTOM_HAL_COMBO = mt6735
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
#start modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_HAL_IMGSENSOR = ar1335_mipi_raw ov5648_mipi_raw ov5648_sunny_mipi_raw
#end modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_HAL_LENS = dw9718af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS =
CUSTOM_HAL_MAIN_IMGSENSOR = ar1335_mipi_raw
...
#start modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_HAL_SUB_IMGSENSOR = ov5648_mipi_raw ov5648_sunny_mipi_raw
#end modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
...
CUSTOM_KERNEL_CAM_CAL = ar1335_otp
CUSTOM_KERNEL_CORE = src
CUSTOM_KERNEL_DCT = dct
CUSTOM_KERNEL_EEPROM = dummy_eeprom
CUSTOM_KERNEL_FLASHLIGHT = constant_flashlight
#wangyufei@yulong.com modify for remove gyro_begin 20150422
CUSTOM_KERNEL_GYROSCOPE = no
#wangyufei@yulong.com modify for remove gyro_begin 20150422
CUSTOM_KERNEL_HEADSET = accdet
#start modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_KERNEL_IMGSENSOR = ar1335_mipi_raw ov5648_mipi_raw ov5648_sunny_mipi_raw
#end modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718af dummy_lens
#wangyufei@yulong.com modify for remove magetometer_begin 20150422
CUSTOM_KERNEL_MAGNETOMETER = no
#wangyufei@yulong.com modify for remove magnetometer end  20150422
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = dw9718af
CUSTOM_KERNEL_MAIN_IMGSENSOR = ar1335_mipi_raw
...
#start modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_KERNEL_SUB_IMGSENSOR = ov5648_mipi_raw ov5648_sunny_mipi_raw
#end modify for add ov5648 of sunny by miaolei@yulong.com 2015.06.06
CUSTOM_KERNEL_SUB_LENS = dummy_lens
#/*start to modify for 8298 TW driver code building by qinxinjun@yulong.com in 20150513*/
CUSTOM_KERNEL_TOUCHPANEL = GT915L_yulong
#/*end to modify for 8298 TW driver code building by qinxinjun@yulong.com in 20150513*/
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_MODEM = LWG_DSDS
...
EVB = no
#liyongfeng@yulong.com modify for tee caused boot error start
#MTK_ATF_BOOT_OPTION = 2
#liyongfeng@yulong.com modify for tee caused boot error end
EVDO_DT_SUPPORT = no
...
#modify for close AAL by xuzhixian@yulong.com 20150806 start
MTK_AAL_SUPPORT = no
#modify for close AAL by xuzhixian@yulong.com 20150806 end
MTK_ACMT_DEBUG = no
...
#wangyufei@yulong.com baibo@yulong.com modify for audio mic begin 20150526
MTK_AUDIO_MIC_INVERSE = no
#wangyufei@yulong.com baibo@yulong.com modify for audio mic end 20150526
#yulong begin close MTK_AUDIO_PROFILES by zhangjunnan@yulong.com 20150527
...
#wangyufei@yulong.com modify for gsensor begin at 20150422
MTK_AUTO_DETECT_ACCELEROMETER = yes
#wangyufei@yulong.com modify for gsensor end at 20150422
MTK_AUTO_DETECT_ALSPS = no
MTK_AUTO_DETECT_MAGNETOMETER = no
MTK_AUTO_SANITY = no
MTK_AVI_PLAYBACK_SUPPORT = yes
#modify by fubin1@yulong.com at 20150422 to charging low bat voltage start.
MTK_BATLOWV_NO_PANEL_ON_EARLY = yes
#modify by fubin1@yulong.com at 20150422 to charging low bat voltage end.
MTK_BATTERY_PROTECT = no
#yulong wangzhen2 modify for build error: PLEASE turn on MTK_NFC_SUPPORT or turn off MTK_BEAM_PLUS_SUPPORT
...
MTK_BT_SUPPORT = yes
#begin baijie@yulong.com 2015-07-13 modify for ygps show bd nav prnNo 
MTK_BUILD_VERNO = ALPS.L1.MP3.V2_YL6735.65C.L1_P130
#end baijie@yulong.com 2015-07-13 modify for ygps show bd nav prnNo
MTK_BWC_SUPPORT = yes
MTK_C2K_SUPPORT = no
MTK_CACHE_MERGE_SUPPORT = no
#yulong begin modified by wanghongliang@yulong.com @2015.03.27
...
# close ivHDR by weiwenping@yulong.com 20150525
...
#modify by lihan@yulong.com 2015-4-21
MTK_DRM_APP = no
#end by lihan@yulong.com 2015-4-21
MTK_DRM_KEY_MNG_SUPPORT = no
MTK_DRM_PLAYREADY_SUPPORT = no
MTK_DSPIRDBG = no
MTK_DTAG_DUAL_APN_SUPPORT = no
MTK_DT_SUPPORT = no
#modify MTK_DUAL_MIC_SUPPORT baibo@yulong.com 20150420
...
#modify by fubin1@yulong.com at 20150416 to support fan5405 start.
MTK_FAN5405_SUPPORT = yes
#modify by fubin1@yulong.com at 20150416 to support fan5405 end.
...
MTK_FIRST_MD = 1
#[YULONG-START][2015.6.9][zhangqing1@yulong.com]do not close MD while change to flight mode
MTK_FLIGHT_MODE_POWER_OFF_MD = no
#[YULONG-END][2015.6.9][zhangqing1@yulong.com]do not close MD while change to flight mode
...
#modify MTK_INCALL_NORMAL_DMNR baibo@yulong.com 20150521
...
#yulong close MTK_MASS_STORAGE  by zhangjunnan@yulong.com 20150618
MTK_MASS_STORAGE = no
...
MTK_PRODUCT_LOCALES = en_US zh_CN
...
MTK_SWIP_VORBIS = yes
MTK_SWIP_WMAPRO = no
#yulong begin,delete by wanghongliang@yulong.com @2015.06.15
...
#yulong begin, modify by baijie@yulong.com 20150619 for mtk patch24
MTK_WEEK_NO = W15.39
#yulong end, modify by baijie@yulong.com 20150619 for mtk patch24
...
#yulong add begin by wangsheng@yulong.com for cts android.text.util.cts.LinkifyTest#testAddLinks1 FAIL at 20150709
...
#CREATE_PROJECT_INFO=2015050811954
